...
async function duplicateTeamName(e){
  console.log("입력한 팀이름 : " + e.value)

  let url = convertURL("/team/duplicatetName?tName=" + e.value)
  ...
  try{
    ...
    if (result == "중복"){
      ...
      document.getElementById("duplicate").innerText = "이미 존재하는 팀명입니다."
    }else if(result == "사용가능"){
      document.getElementById('duplicate').innerText = "사용가능한 팀명입니다."
      document.getElementById('duplicate').style = "color:blue;"
    }
  }catch (err){
    console.log("duplicatetName 패치 후 오류 : " + err)
  }
