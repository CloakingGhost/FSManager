...
public class SchedulerWeather {
    ...
    @Value("${openweather.api.appkey1}")
    String apiKey;
    @Value("${openweather.api.appkey2}")
    String apiKey2;
