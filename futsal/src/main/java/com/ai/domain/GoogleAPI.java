...
public class GoogleAPI {
	...
	public String getAccessToken(String code, HttpServletRequest request, String clientId, String clientSecret) {
		String accessToken = "";
		String refreshToken = "";
		String reqUrl = "https://oauth2.googleapis.com/token";
		if(CheckDevenv.DEVENV == false){
			// 서버 배포용
			redirectURI = "https://www.fsmanager.run" + request.getContextPath() + "/loginAccess";
		} else {
			// 개발용
			redirectURI = "http://localhost:8080/loginAccess";
		}
